...
public class LocationUpdatesService extends Service {
    ...
    private static final String PACKAGE_NAME = "com.cyclebikeapp.ble";
    ...
    static final String EXTRA_LOCATION_STATUS = "extra_location_status_update";
    static final String EXTRA_LOCATION_STATUS_TYPE = "extra_location_status_type";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (MainActivity.debugAppState)Log.i(TAG, "Service started");
    ...
    public void requestLocationUpdates() {
        if (MainActivity.debugAppState)Log.i(TAG, "Requesting location updates");
        ...
        try {
            ...
            if (MainActivity.debugAppState)Log.e(TAG, "Lost location permission. Could not request updates. " + unlikely);
        }
    }
    ...
    public void removeLocationUpdates() {
        if (MainActivity.debugAppState)Log.i(TAG, "Removing location updates");
        try {
            ...
            Utilities.setRequestingLocationUpdates(this, true);
            if (MainActivity.debugAppState)Log.e(TAG, "Lost location permission. Could not remove updates. " + unlikely);
        }
    }
...
/**
    ...
    private void onNewLocation(Location location) {
        if (MainActivity.debugAppState)Log.i(TAG, "New location: " + location);
        mLocation = location;
        // Notify anyone listening for broadcasts about the new location.
        Intent intent = new Intent(ACTION_BROADCAST);
        intent.putExtra(EXTRA_LOCATION, location);
        intent.putExtra(EXTRA_LOCATION_STATUS_TYPE, EXTRA_LOCATION_STATUS);
