...
public class BLEOppositePowerService extends Service {
    private final static String LOGTAG = BLEOppositePowerService.class.getSimpleName();
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                intentAction = ACTION_OPPOSITE_POWER_GATT_CONNECTED;
                ...
                intentAction = ACTION_OPPOSITE_POWER_GATT_DISCONNECTED;
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                broadcastUpdate(ACTION_OPPOSITE_POWER_GATT_SERVICES_DISCOVERED);
            } else {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                broadcastUpdate(ACTION_OPPOSITE_POWER_DATA_AVAILABLE, characteristic);
            }
        }
        @Override
    ...
    private void broadcastUpdate(final String action) {
        ...
        intent.putExtra(EXTRAS_DEVICE_OPPOSITE_POWER_ADDRESS, mBluetoothDeviceAddress);
    ...
    private void broadcastUpdate(final String action, final BluetoothGattCharacteristic characteristic) {
        ...
        intent.putExtra(EXTRA_OPPOSITE_POWER_DATA_TYPE, shortUUID);
        switch (type) {
     ...
     */
                //if (debugBLEPowerData || debugBLEPowerCal || debugBLEPowerCrank) {Log.i(LOGTAG, "received byte hex data: " + byteToHexString(characteristic.getValue()));}
                if (debugBLEPowerData || debugBLEPowerCal || debugBLEPowerCrank) {Log.i(LOGTAG, "Device_opposite_power_address: " + mBluetoothDeviceAddress);}
    ...
    /*                if (debugBLEPowerData) {
               ...
               Log.d(LOGTAG, "Accumulated Torque Present = bit 3");
                ...
                if (isOffsetCompensationIndicator) {
                    ...
                    intent.putExtra(EXTRA_OPPOSITE_POWER_DATA, hexString);
            ...
            case BIKE_POWER_CONTROL_PT:
                ...
                intent.putExtra(EXTRA_OPPOSITE_PCP_OPCODE, opCode);
                if (debugBLEPowerCal || debugBLEPowerCrank) {Log.i(LOGTAG, "Opposite Power Control Point opCode: " + opCode);}
                if (opCode == CALIBRATE_POWER_OPCODE && responseValue == RESPONSE_VALUE_SUCCESS) {
                    ...
                    if (debugBLEPowerCal) {Log.i(LOGTAG, "Opposite Power Control Point calValue: " + calValue);}
                    ...
                    if (debugBLEPowerCrank) {Log.i(LOGTAG, "Opposite Power Control Point crankLengthValue: " + crankLengthValue);}
    ...
    class LocalBinder extends Binder {
        BLEOppositePowerService getService() {
            return BLEOppositePowerService.this;
        }
    }
    ...
    private Notification getNotification() {
        Intent intent = new Intent(this, BLEOppositePowerService.class);
        CharSequence text = "";
    ...
    private static final String TAG = BLEOppositePowerService.class.getSimpleName();
    /**
     * The name of the channel for notifications.
     */
    private static final String CHANNEL_ID = "BLEOppPowerService";
    ...
    private final IBinder mBinder = new BLEOppositePowerService.LocalBinder();
    ...
    private void writeCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        if (debugBLEService){
            Log.w(LOGTAG, "writing characteristic");
        }
